...
<img src="https://cdn.uwayfly.com/article/2026/1/own_mike_6Fm4BS6364czsZX4.png" width="700" />
...
所有文件，包括位图、图标、字体、其他文件等，所有方式，包括在线网站、MCP、`cos.git` 等，都会进行 CDN 缓存刷新！
...
<img src="https://cdn.uwayfly.com/article/2026/1/own_mike_sAE6pZ7sTr2KDF4Z.png" width="700" />

<img src="https://cdn.uwayfly.com/article/2026/1/own_mike_JhibY2D6ZWk4YQMT.png" width="700" />
...
1. 图标由设计师在最上游处理好，重构、前端无需接入，全自动化，只需手动触发更新、审核即可
...
4. 图标项目需要有有自己的蓝盾流水线，用于执行拉取 SVG、生成 `iconfont`、创建 MR等，字体项目不需要
