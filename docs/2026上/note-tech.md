...
> **2026-01-19** — npx prettier scripts/generat…
>
> npx prettier scripts/generate-css-vars.mjs --write

---

> **2026-01-18** — contentHeight 就是 popoverCont…
>
> contentHeight 就是 popoverContentHeight，这样就好理解多了。

---

> **2026-01-17** — popover 组件的 placement 取值有 le…
>
...
> **2026-01-12** — 本质是方案设计：优秀的 Prompt 源自对问题的深刻洞…
>
...
> **2026-01-12** — - 如果组件库质量差（类型定义不全、缺少 Demo），再…
>
...
> **2026-01-11** — 计算属性只在相关响应式依赖发生改变时它们才会重新求值。这…
>
...
> **2026-01-10** — - 技术优化在业务应用中的稳定性和可靠性：是否能够长时间…
>
...
> **2026-01-09** — 在做中学：不要依赖AI，我们不仅是在打造软件，还在打造个…
>
