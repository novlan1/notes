...
2. ✅ **新增**：[cli/codegen/sync-props.mjs](packages/uniapp-x-components/cli/codegen) — 纯 ts-morph 脚本同步 props
3. ✅ **新增**：[cli/codegen/diff-css-tokens.mjs](packages/uniapp-x-components/cli/codegen) — token 表对比
