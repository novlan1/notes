...
> [vitepress:local-search] Could not load /@localSearchIndex (imported by node_modules/.pnpm/vitepress@1.6.3_@algolia+client-search@5.25.0_@types+node@17.0.45_axios@1.9.0_less@4.5._6333351eba3c171df7eaf4a4397a9e7c/node_modules/vitepress/dist/client/theme-default/components/VPLocalSearchBox.vue?vue&type=script&setup=true&lang.ts): MiniSearch: duplicate ID /t-comm/zh/galileo-api.html#GalileoMessageSearch
[vitepress:local-search] Could not load /@localSearchIndex (imported by node_modules/.pnpm/vitepress@1.6.3_@algolia+client-search@5.25.0_@types+node@17.0.45_axios@1.9.0_less@4.5._6333351eba3c171df7eaf4a4397a9e7c/node_modules/vitepress/dist/client/theme-default/components/VPLocalSearchBox.vue?vue&type=script&setup=true&lang.ts): MiniSearch: duplicate ID /t-comm/zh/galileo-api.html#GalileoMessageSearch
...
[`script/docs-jsdoc/markdown.js`](command:gongfeng.gongfeng-copilot.chat.open-relative-path?%7B%22%24mid%22%3A1%2C%22fsPath%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2Fscript%2Fdocs-jsdoc%2Fmarkdown.js%22%2C%22path%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2Fscript%2Fdocs-jsdoc%2Fmarkdown.js%22%2C%22scheme%22%3A%22file%22%7D) 用的是 [`jsdoc-to-markdown`](command:gongfeng.gongfeng-copilot.chat.open-relative-path?%7B%22%24mid%22%3A1%2C%22fsPath%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2Fscript%2Fdocs-jsdoc%2Fmarkdown.js%22%2C%22path%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2Fscript%2Fdocs-jsdoc%2Fmarkdown.js%22%2C%22scheme%22%3A%22file%22%7D)（jsdoc 解析器），它**原生不支持 TypeScript 语法**。

[`log.ts`](command:gongfeng.gongfeng-copilot.chat.open-relative-path?%7B%22%24mid%22%3A1%2C%22fsPath%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2Fsrc%2Fgalileo-api%2Flog.ts%22%2C%22path%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2Fsrc%2Fgalileo-api%2Flog.ts%22%2C%22scheme%22%3A%22file%22%7D) 里对每个枚举成员都加了 JSDoc 注释：
...
jsdoc 解析器看到这些 `/** */`，会把它们当成"独立的成员"，但因为它**不认识 `DEFAULT = 0` 这种 TS 枚举成员的 AST**，于是生成出来的成员名 [`name`](command:gongfeng.gongfeng-copilot.chat.open-symbol-in-file?%5B%7B%22%24mid%22%3A1%2C%22fsPath%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2Fsrc%2Fgalileo-api%2Flog.ts%22%2C%22external%22%3A%22file%3A%2F%2F%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2Fsrc%2Fgalileo-api%2Flog.ts%22%2C%22path%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2Fsrc%2Fgalileo-api%2Flog.ts%22%2C%22scheme%22%3A%22file%22%7D%2C%22name%22%2C%5B%7B%22line%22%3A45%2C%22character%22%3A2%7D%2C%7B%22line%22%3A45%2C%22character%22%3A15%7D%5D%5D) 为 [`undefined`](command:gongfeng.gongfeng-copilot.chat.open-symbol-in-file?%5B%7B%22%24mid%22%3A1%2C%22fsPath%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2Fsrc%2Fgalileo-api%2Flog.ts%22%2C%22external%22%3A%22file%3A%2F%2F%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2Fsrc%2Fgalileo-api%2Flog.ts%22%2C%22path%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2Fsrc%2Fgalileo-api%2Flog.ts%22%2C%22scheme%22%3A%22file%22%7D%2C%22undefined%22%2C%5B%7B%22line%22%3A258%2C%22character%22%3A36%7D%2C%7B%22line%22%3A258%2C%22character%22%3A45%7D%5D%5D)。然后模板 [`template.hbs`](command:gongfeng.gongfeng-copilot.chat.open-relative-path?%7B%22%24mid%22%3A1%2C%22fsPath%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2Fscript%2Fdocs-jsdoc%2Ftemplate.hbs%22%2C%22path%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2Fscript%2Fdocs-jsdoc%2Ftemplate.hbs%22%2C%22scheme%22%3A%22file%22%7D) 里渲染时用了 `{{@parent}}{{@accessSymbol}}{{name}}` 的格式，最终就拼出了：
...
可以对照 [`location-interface.ts`](command:gongfeng.gongfeng-copilot.chat.open-relative-path?%7B%22%24mid%22%3A1%2C%22fsPath%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2Fsrc%2Flocation%2Flocation-interface.ts%22%2C%22path%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2Fsrc%2Flocation%2Flocation-interface.ts%22%2C%22scheme%22%3A%22file%22%7D) 里的 `LocationFlag`（用 [`//`](command:gongfeng.gongfeng-copilot.chat.open-relative-path?%7B%22%24mid%22%3A1%2C%22fsPath%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2F%22%2C%22path%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2F%22%2C%22scheme%22%3A%22file%22%7D) 行注释而不是 `/** */`），就完全不会出现这个问题。

### 2. 为什么 `docs:build` 失败？

VitePress 的本地搜索（local-search）对每个 markdown heading 自动生成锚点 ID（基于 `## 标题`）。

生成的 [`galileo-api.md`](command:gongfeng.gongfeng-copilot.chat.open-relative-path?%7B%22%24mid%22%3A1%2C%22fsPath%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2Fdocs%2Fzh%2Fgalileo-api.md%22%2C%22path%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2Fdocs%2Fzh%2Fgalileo-api.md%22%2C%22scheme%22%3A%22file%22%7D) 里出现了**多个完全相同的 heading**：
...
我推荐**最小改动方案**：把 `log.ts` 里枚举成员上面的 `/** ... */` JSDoc 注释改成普通的 [`//`](command:gongfeng.gongfeng-copilot.chat.open-relative-path?%7B%22%24mid%22%3A1%2C%22fsPath%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2F%22%2C%22path%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2F%22%2C%22scheme%22%3A%22file%22%7D) 行内注释，跟项目里其他 enum（比如 `LocationFlag`）保持一致。这样 jsdoc 就不会把成员当成独立条目去解析，避免生成 `[undefined]`。

> ⚠️ 这里只动 `log.ts`，没动构建脚本，是因为这是项目里唯一一个把 `/** */` 加在枚举成员上的写法，其他 enum 都是用 [`//`](command:gongfeng.gongfeng-copilot.chat.open-relative-path?%7B%22%24mid%22%3A1%2C%22fsPath%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2F%22%2C%22path%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2F%22%2C%22scheme%22%3A%22file%22%7D)。这是最小、最低风险、最一致的改法。

是否帮你直接改 [`log.ts`](command:gongfeng.gongfeng-copilot.chat.open-relative-path?%7B%22%24mid%22%3A1%2C%22fsPath%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2Fsrc%2Fgalileo-api%2Flog.ts%22%2C%22path%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2Fsrc%2Fgalileo-api%2Flog.ts%22%2C%22scheme%22%3A%22file%22%7D)？改完后再 `npm run docs:gen && npm run docs:build` 应该就能通过了。

如果你坚持希望在源码里保留 `/** */` 形式（因为它在 IDE hover 时更友好），还有另一个方案：在 [`markdown.js`](command:gongfeng.gongfeng-copilot.chat.open-relative-path?%7B%22%24mid%22%3A1%2C%22fsPath%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2Fscript%2Fdocs-jsdoc%2Fmarkdown.js%22%2C%22path%22%3A%22%2FUsers%2Fguowangyang%2FDocuments%2Fgit-woa%2F1.basic-repos%2Ftx-t-comm%2Fscript%2Fdocs-jsdoc%2Fmarkdown.js%22%2C%22scheme%22%3A%22file%22%7D) 里加一个清洗步骤，把生成结果中包含 `[undefined]` 的 heading 整段过滤掉。但这个改动面更大、更"hack"，所以**优先推荐方案一**。
。
...
`press-transition` 在你项目的 `src` 里**没有任何代码直接 import**。它是被 `@tencent/press-ui` 其它组件（`press-overlay`、`press-toast`、`press-notify`、`press-image`、`press-back-top` 等）作为子组件 `usingComponents` 间接引用而被打包进来。

更关键的：`@tencent/press-ui` 是**源码发布**的 `press-transition.vue`、`css/index.scss`），需要项目自己用 `vite-plugin-uni` 把 `.vue` 编译成 `wxml/json/wxss/js` 这一整套四件套。

#### 2. 构建机上"只有 json/wxml/wxss，缺 js"的根因

这种"四件套只少 `.js`"的现象，几乎只有一种原因：

> **构建过程中，vite/rollup 在编译 `press-transition.vue` 的 `<script>` 阶段失败/被跳过，但 `<template>`（→ wxml）、`<style>`（→ wxss）、`usingComponents` 元信息（→ json）依然由 `@dcloudio/uni-mp-vue` 的元数据收集流程正常输出了。**
...
- 用 npm 安装时，`@tencent/press-ui` 会被扁平化平铺到 `node_modules/@tencent/press-ui`，但**对等依赖（peerDependencies）、嵌套 `.vue` 解析、`@dcloudio/uni-cli-shared` 对 node_modules 的扫描白名单**都和 pnpm 行为不一致，常导致 `.vue` 的 script 部分被识别为"已经是产物，无需编译"而跳过。

##### ✅ 可能原因 C：构建机用了 `NODE_ENV=production` + Tree-shaking 把空模块当死代码删了
- 看 [press-transition.js](/Users/guowangyang/Documents/git-woa/val-match-next/dist/build/mp-weixin/node-modules/@tencent/press-ui/press-transition/press-transition.js) 的内容，整个模块就只是 `wx.createComponent(...)`，没有任何 export。
- 在生产模式 + 严格 sideEffects 配置下，rollup 可能判断此 chunk "无副作用且无被导入处"，整条 chunk 被裁掉，但 emitFile 已经吐出了 wxml/wxss/json。
- 注意 `@tencent/press-ui` 的 `package.json` 是否把 `*.vue` 标记为 `"sideEffects": false`。
...
1. **拿到构建机的完整 build log**
   重点搜：`press-transition`、`failed to transform`、`Could not resolve`、`plugin:vite:vue`。这是最直接的证据。

2. **统一包管理器**
   构建机改成 `pnpm install --frozen-lockfile`，并使用与本地一致的 pnpm 版本（`pnpm -v` 比对）。`package.json` 里加：
   ```json
...
4. **强制 include 该依赖**（验证 A/B 假设）
   修改 [vite.config.ts](/Users/guowangyang/Documents/git-woa/val-match-next/vite.config.ts) 的 `optimizeDepsIncludes`，加入 `@tencent/press-ui`，确认是不是依赖优化把它漏了：
   ```ts
...
5. **核对 Node/OS 大小写敏感性**
   构建机执行 `uname -a && node -v && pnpm -v`，确认与本地差异；本仓库源码中所有 `from '@tencent/press-ui/press-xxx/press-xxx'` 大小写必须严格一致。

6. **临时兜底方案**
   如果时间紧、必须先发版，可以在 `src` 任意 `entry`（如 [main.ts] 或 App.vue）里加一行**显式 import** 触发 rollup 真正把它编译为产物：
   ```ts
...
<img src="https://cdn.uwayfly.com/article/2026/6/own_mike_RH4rFS8aDjthx46x.png" width="500"/>

<img src="https://cdn.uwayfly.com/article/2026/6/own_mike_RPhwy3RrZtz453iN.png" width="500"/>

## trie 是什么

`2026-06-16`

<img src="https://cdn.uwayfly.com/article/2026/6/own_mike_QsfkXPsszxBHTBdW.png" width="500"/>

<img src="https://cdn.uwayfly.com/article/2026/6/own_mike_GKGsy5Q4twebMk3Z.png" width="500"/>

## trie

`2026-06-16`

<img src="https://cdn.uwayfly.com/article/2026/6/own_mike_5QTextBGc7KKFWbJ.png" width="500"/>
...
因为必须用**本轮更新前的旧值**来做转移，不能用已经被当前 `num` 污染过的值。

举个例子：假设 `dp = [0, -Inf, -Inf]`，当前 `num = 2`。

**正确做法（读 `dp[r]`）：**
- `r=0`: `newR = (0+2)%3 = 2`，`tmp[2] = max(-Inf, dp[0]+2) = 2`
- `r=1`: `newR = (1+2)%3 = 0`，`tmp[0] = max(0, dp[1]+2) = max(0, -Inf) = 0`
- `r=2`: `newR = (2+2)%3 = 1`，`tmp[1] = max(-Inf, dp[2]+2) = -Inf`

结果：`tmp = [0, -Inf, 2]` ✅ 只选了一次 `num=2`

**错误做法（读 `tmp[r]`）：**
- `r=0`: `newR = 2`，`tmp[2] = max(-Inf, tmp[0]+2) = 0+2 = 2` ← 此时 tmp[2] 变成 2
- `r=2`: `newR = 1`，`tmp[1] = max(-Inf, tmp[2]+2) = 2+2 = 4` ❌

`tmp[2]` 已经是"选了 `num`"的结果（值为 2），再从 `tmp[2]` 转移相当于**把同一个 `num` 加了两次**（0→2→4），这就错了。
