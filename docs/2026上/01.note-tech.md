...
更关键的：`@tencent/press-ui` 是**源码发布**的（[press-transition.vue](/Users/guowangyang/Documents/git-woa/val-match-next/node_modules/.pnpm/@tencent+press-ui@5.0.29/node_modules/@tencent/press-ui/press-transition/press-transition.vue)、`css/index.scss`），需要项目自己用 `vite-plugin-uni` 把 `.vue` 编译成 `wxml/json/wxss/js` 这一整套四件套。
